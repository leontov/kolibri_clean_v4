...
- Песочница и политики: 33, 36, 38, 43, 45 → deny-by-default, лимиты CPU/NET/FS, токены по скоупам, журнал `skill_quota_blocked`.
- SkillStore v1: 41, 46 → манифест, статический анализ публикаций, интерфейс `SkillQuota`.
